...
class Shock :
    ...
    def finger_angle( self ) -> Optional[float] :
        ...
        v1 = Vector2(0, 0)
        v2 = Vector2(self.finger_pos.x - self.container_center.x,
    ...
    def render( self ) :
        if self.container_center is not None :
            ...
            overstep = True
            if point_in_circle(self.finger_pos,self.container_center,self.container_radius):
                color = 'blue'
                overstep = False
            ...
            stick_color = self.stick_color.lerp(self.stick_max_color,self.normalize_distance)

            pg.draw.circle(cr.screen, stick_color, finger_pos, self.stick_radius)
            pg.draw.circle(cr.screen, self.container_color, self.container_center,
